...
GBL.CONSTANTS.set(`LANGUAGE`, {'BASE': LANGUAGE}, true);
...
export const CONST = {
    ...
    DESIGN: {
        THEME: "default",
        BUTTON: {
            OK: `<button type="button" class="custom-button custom-button-info customAlertButtonForOk">${_language.BASE.BUTTON.OK}</button>`,
            DEL: `<button type="button" class="custom-button custom-button-danger customAlertButtonForDelete">${_language.BASE.BUTTON.DELETE}</button>`,
            CANCEL: `<button type="button" class="custom-button custom-button-secondary customAlertButtonForCancel">${_language.BASE.BUTTON.CANCEL}</button>`
        }
    },
