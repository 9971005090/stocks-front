...
export const CONST = {
    ...
    DESIGN: {
        THEME: "default",
        BUTTON: {
            OK: `<button type="button" class="custom-button custom-button-info customAlertButtonForOk">확인</button>`,
            DEL: `<button type="button" class="custom-button custom-button-danger customAlertButtonForDelete">네. 삭제합니다</button>`,
            CANCEL: `<button type="button" class="custom-button custom-button-secondary customAlertButtonForCancel">취소</button>`
        }
    },
