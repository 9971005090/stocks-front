                    ...
                    {{#if VIEW.IS_INDEX}}
                        ...
                        <div class="cont">
                            ...
                            <div class="cm-device-search">
                                <button type="submit" class="device-search-btn form-common-search-button">
                                    <span class="img"></span>
                                </button>
                            </div>
                            {{/if}}
...
export const dataTable = `
    {{#each datas}}
        ...
        {{#each ../_c.COLUMN}}
            {{#customIf TYPE '==' 'check-box'}}
                <div class="cm-td {{ADD_CLASS}}" style="{{STYLE.TD_STYLE}}">
                    <div class="cm-checkbox-box type02 pd-4" style="{{STYLE.DIV_STYLE}}">
                        <input class="input" type="checkbox" value="" id="checkbox_{{_t ../this DATA_ID}}">
                    </div>
                </div>
            {{/customIf}}
            {{#customIf TYPE '==' 'number'}}
                <div class="cm-td td-num {{ADD_CLASS}}" style="{{STYLE.TD_STYLE}}">{{_t ../this DATA_ID}}</div>
            {{/customIf}}
            {{#customIf TYPE '==' 'text'}}
            <div class="cm-td {{ADD_CLASS}}" style="{{STYLE.TD_STYLE}}">
                <div class="pc-d-none">
                {{#each TITLE}}
                <span class="pc-d-none">{{name}}</span>
                {{/each}}
                </div>
                {{#each DATA_PARSING}}
                {{_t ../../this key}}<br>
            ...
            <div class="cm-td {{ADD_CLASS}}" style="{{STYLE.TD_STYLE}}">
                <div class="btn-wrap" style="{{STYLE.DIV_STYLE}}">
                    {{#each DATA_PARSING}}
                    <button type="button" class="cm-btn cm-btn-small {{key}}">{{name}}</button>
                    {{/each}}
                </div>
            </div>
            {{/customIf}}
            ...
            <div class="search-form">
                {{#each _c}}
                    {{#if VIEW.IS_ADD}}
                        ...
                        {{/customIf}}
                        {{#customIf VALUE.TYPE '==' 'number'}}
                            <div class="tit {{#if VIEW.ACTIVE}}require-validation{{/if}}">{{VIEW.TITLE}}</div>
                            <div class="cont">
                                <div class="cm-input-cont">
                                    <input type="number" class="cm-input-text {{#if VIEW.ACTIVE}}check active-check{{/if}}" placeholder="{{VALUE.PLACEHOLDER}}" name="{{VALUE.NAME}}"
                                        {{#if VALUE.IS_CHECK}}
                                            {{#each VALUE.LIMIT}}
                                                min="{{../VALUE.LIMIT.MIN}}"
                                                max="{{../VALUE.LIMIT.MAX}}"
                        ...
                        {{/customIf}}
                        {{#customIf VALUE.TYPE '===' 'file'}}
                            <div class="tit {{#if VIEW.ACTIVE}}require-validation{{/if}}">{{VIEW.TITLE}}</div>
                            <div class="cont">
                                <div class="cm-input-cont display-flex" style="gap:8px;">
                                    <label for="{{VALUE.NAME}}" class="cm-btn cm-btn-small cm-btn-default">파일찾기</label>
                                    <input class="upload-name" type="text" placeholder="첨부파일" readonly />
                                    <input type="file" name="file" class="cm-input-text check active-check" id="{{VALUE.NAME}}">
                                </div>
                            </div>
                        {{/customIf}}
                    {{/if}}
            ...
            {{#each _c}}
                {{#if VIEW.IS_UPDATE}}
                    ...
                    {{#customIf VALUE.TYPE '==' 'number'}}
                        ...
                        <div class="cont">
                            <div class="cm-input-cont">
                                <input type="number" class="cm-input-text {{#if VIEW.ACTIVE}}check active-check{{/if}}" value="{{_d ../datas VALUE.COLUMN}}" name="{{VALUE.NAME}}" autocomplete="off" {{#if VALUE.IS_DISABLED}}disabled{{/if}} placeholder="{{VALUE.PLACEHOLDER}}" 
                                {{#if VALUE.IS_CHECK}}
                                    {{#each VALUE.LIMIT}}
                                        min="{{../VALUE.LIMIT.MIN}}"
                                        max="{{../VALUE.LIMIT.MAX}}"
...
export const dynamic = `
    <div class="common-cont">
        ...
        <div class="cm-table-wrap board-view" style="display:none;">
            <div class="cm-table-cont">
            <div class="cm-colgroup">
                    {{#each _d}}
                    <div style="width:{{STYLE.WIDTH}}"></div>
