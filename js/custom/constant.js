...
GBL.ACCOUNT.AFTER_LOGIN_URL = "/gateway/index";
GBL.MANAGER_PREFIX = "";
...
GBL.DESIGN.THEME = "thync-manager";
...
GBL.DESIGN.DEFAULT_CONTROLLER = "gateway";
GBL.DESIGN.DEFAULT_ACTION = "index";
GBL.DESIGN.APP_EXPLAIN_CONFIRM = true; // 최종 설치 여부..
GBL.DESIGN.SITE_META.NAME = "THYNC MANAGER";
GBL.DESIGN.SITE_META.TYPE = "website";
GBL.DESIGN.SITE_META.TITLE = "THYNC MANAGER";
